...
public class Enacter implements Runnable {
    ...
    public void run() {
        ...
        EnactmentEngine enacter = new EEClient(ENACTMENT_ENGINE_HOST);
        ...
        StringBuilder chorMachinesMessage = new StringBuilder("Machines used by choreography  #" + idx + " (chorId="
                + chorId + "):");
